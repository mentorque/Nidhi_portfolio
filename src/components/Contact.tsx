  ...
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "nidhivsharma.10@gmail.com",
      href: "mailto:nidhivsharma.10@gmail.com",
      primary: true
    },
    {
      ...
      <div className="container mx-auto max-w-4xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            I'm a Business Analytics professional with 3+ years of experience and actively seeking 
            opportunities in Ireland to turn complex data into actionable insights and drive smarter decisions.
          </p>
        </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-sm text-muted-foreground">
                    ...
                    <p>2024 – 2025</p>
                    <p className="mt-2 font-medium text-primary">SRCOEM</p>
