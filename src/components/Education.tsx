  ...
  const education = [
    {
      ...
      period: "2024 – 2025",
      gpa: "",
      coursework: ["Statistical Methods", "Optimization in Business", "Data Management and Mining", "Technology Consulting"],
      logo: "UCD"
    },
    {
      ...
      period: "2017 – 2021",
      gpa: "",
      coursework: ["Database and Management Systems", "Data Structure and Algorithms", "Operating Systems", "System Design"],
      logo: "SRC"
    }
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            My academic journey in Business Analytics and Computer Science, with a commitment to continuous learning
          </p>
        </div>
